...
AppointmentController {
    ...
    public String saveAppointment(@RequestBody Appointment appointment) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\Documents\\Projects\\Medical-Appointment-Scheduling-System-\\Back-end\\src\\main\\java\\Medical\\Appointment\\System\\Back_end\\ApointmentSytem\\appointments.txt", true))) {
