...
public class CorsConfig implements WebMvcConfigurer{
    ...
    public String registerUser(@RequestBody User user) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(
                "C:\\Users\\rashi\\Documents\\GitHub\\Medical-Appointment-Scheduling-System-\\Back-end\\src\\main\\java\\Medical\\Appointment\\System\\Back_end\\UserRegistration\\Registration.txt",
                true))) {
